...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('courses', '0006_auto_20171229_1024'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='materiais', to='courses.Lesson', verbose_name='Aula')),
            ],
            options={
        ...
        migrations.AlterField(
            ...
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='announcement', to='courses.Course', verbose_name='Curso'),
        ),
    ]
